...
const cardData = [
  {
    id: 1,
    act: 1,
    title: "初始加载页 / Brand Opening",
    intent: "在进入产品前建立品牌气质与出发情绪，让用户先感知「轻旅行」的核心调性。",
    decision:
      "以飞机舷窗、蓝天与大标题构成首屏主视觉，优先传达轻盈、年轻、即将启程的旅行氛围。",
    insight: "用户在第一屏即可理解产品定位，并更愿意继续进入后续流程。",
  ...
  },
  {
    ...
    act: 1,
    title: "登录页 / Login",
    intent: "降低账号进入门槛，同时保持视觉语境连续，避免登录页与产品体验割裂。",
    decision:
      "整合密码登录、验证码登录与微信登录三种入口，并将风景背景与登录卡片并置，兼顾功能与旅行氛围。",
    insight: "登录路径更清晰，用户在完成账户操作时仍能保持沉浸感。",
  ...
  },
  {
    ...
    act: 2,
    title: "首页 / Home Feed",
    intent: "作为内容发现与旅行灵感分发中心，帮助用户快速建立「去哪里、看什么」的方向。",
    decision:
      "通过卡片流整合热门地点、推荐内容、评分评论、点赞与行程时长等关键信息，并接入 AI 智能规划入口。",
    insight: "用户能在连续浏览中快速形成目的地偏好，提升从浏览到决策的转化效率。",
  ...
  },
  {
    id: 4,
    act: 2,
    title: "详情页 / Trip Detail",
    intent: "把单篇旅行内容从图文浏览升级为可执行行程，降低用户落地执行成本。",
    decision:
      "采用大图与文案叙事结合分天 tabs、时间轴安排，并保留点赞、收藏、评论等互动入口，强化可读性与可操作性。",
    insight: "内容不仅能完成种草，也能直接转化为出行参考与执行清单。",
  ...
  },
  {
    ...
    act: 2,
    title: "探索页 / Explore",
    intent: "强化目的地发现与空间感知，引导用户从「看内容」转向「选地点」。",
    decision:
      "以地图背景建立地理语境，使用单地点视觉聚焦与探索人数信息突出目的地氛围，降低选择噪音。",
    insight: "用户更容易自然进入地点探索路径，而不是停留在泛列表浏览。",
  ...
  },
  {
    id: 6,
    act: 3,
    title: "地点详情页 / Destination Hub",
    intent: "把单一目的地组织为可持续浏览的信息集合，支持围绕地点进行深度决策。",
    decision:
      "采用双列卡片聚合同地点下的风景、美食与小众点位内容，并标注 AI 智能规划能力增强行动引导。",
    insight: "用户可在同一目的地维度完成多主题比对，减少跨页检索成本。",
  ...
  },
  {
    id: 7,
    act: 3,
    title: "AI页 / AI Planner",
    intent: "把用户从模糊想法推进到可执行方案，缩短旅行规划起步阶段。",
    decision:
      "使用聊天式输入承接需求表达，输出专属行程方案，并在底部联动推荐地点形成内容承接闭环。",
    insight: "显著降低规划门槛，提升从内容浏览到行程生成的转化能力。",
  ...
  },
  {
    ...
    act: 3,
    title: "搜索页 / Search",
    intent: "帮助用户快速检索目的地、攻略与作者内容，缩短从想法到结果的路径。",
    decision:
      "将搜索框、热门/推荐/高性价比分类、热门地点横滑、搜索历史与当前定位整合到同一入口层级。",
    insight: "用户可在统一搜索界面完成筛选、回看与定位联动，检索效率更高。",
  ...
  },
  {
    ...
    act: 3,
    title: "消息页 / Messages",
    intent: "承接社区互动反馈，增强用户在内容分享后的连接感与回流动机。",
    decision:
      "通过聊天与通知双标签区分私域交流和平台反馈，并聚合评论、收藏、推荐等旅行互动回流信息。",
    insight: "互动关系能够被持续追踪和回应，促进用户形成稳定使用习惯。",
  ...
  },
  {
    ...
    act: 3,
    title: "个人中心 / Profile",
    intent: "集中管理用户资产、行为记录与个人内容，强化账号价值感知。",
    decision:
      "采用顶部数据概览呈现发布数、收藏数与获赞数，下接我的收藏/喜欢/行程/客服/设置及我的发布回顾。",
    insight: "用户对个人内容沉淀与账户状态有更强掌控感，提升长期留存意愿。",
  ...
  },
  {
    ...
    act: 3,
    title: "发布页 / Publish",
    intent: "明确区分内容分享与行程输出两类创作任务，降低发布前的选择成本。",
    decision:
      "通过底部弹层提供发布笔记与发布行程的轻量入口，让用户在当前浏览上下文中快速完成创作分流。",
    insight: "发布动作更直接，既降低创作门槛，也提升内容结构的清晰度。",
